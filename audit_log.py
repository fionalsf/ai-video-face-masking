"""Write audit log for Auto-tier masked events."""
...
def write_audit_log(out_dir: str, video_path: str, auto_events: list[FaceEvent]) -> str:
    path = os.path.join(out_dir, "audit.log")
    lines = [
        f"# audit.log — Auto tier masked events",
